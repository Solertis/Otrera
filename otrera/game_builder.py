...
def create_game_directory_and_file(game_name):
	if os.path.exists("engines/default/games/"+game_name):
		print "A game with this name already exists for this engine!!!"
		exit(1)
	else:
		os.makedirs("engines/default/games/"+game_name)
		gamefile = open("engines/default/games/"+game_name+"/content.json","w+")
